...
(function () {
    ...
    var botCreatorIDs = ["3851534", "4105209" , "3821094"];
    ...
    var basicBot = {
        ...
        cmdLink: "https://git.io/245Ppg",
        chatLink: "https://dl.dropboxusercontent.com/s/h1wjzw58kb8iv1g/en2.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            skipReasons: [
                ...
                ["op", "This song is too titanic -Rohlik 2015"],
